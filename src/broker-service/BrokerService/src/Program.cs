...
using EasyTrade.BrokerService.ProblemPatterns.DelaySimulation;
...
builder.Services.AddTransient<IPluginManager, PluginManager>();
...
builder.Services.AddTransient<DelaySimulationMiddleware>();
builder.Services.AddTransient<TimeoutErrorMiddleware>();
...
app.UseMiddleware<DelaySimulationMiddleware>();
app.UseMiddleware<TimeoutErrorMiddleware>();
